              ...
              {data.data.map((item) => {
                ...
                if (item.title === "Rules and Regulations") {
                  return (
                    <div
                      key={item.id}
                      className={`content special-width ${
                        activeContent === "2" &&
                        (en ||
                          (editedData
                              ...
                              <>
                                ...
                                <div id={item.id}>
                                  {isEditing ? (
                                    ...
                                    <div
                                      className={`${en ? "" : "ar almarai"} ${
                                        !en && !item.arContent ? "content" : ""
                                      }`}
                                    >
                                      {(
                                        editedData.find(
                                        ...
                                        .map((line, index) => {
                                          ...
                                          const blLightRegex =
                                            /<bl-light>(.*?)<\/bl-light>/gi;

                                          const chapterMatch =
                                            chapterRegex.exec(line);
                                          const blLightMatch =
                                            blLightRegex.exec(line);
                ...
                if (item.title === "Buildings & Equipments") {
                  return (
                    <div
                      ...
                      className={`content ${
                        activeContent === "3" &&
                        (en || item.arSub_title || item.arContent)
                          ? "show"
                          : ""
                      }`}
                    >
